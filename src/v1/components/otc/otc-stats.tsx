          ...
          <div className="mt-10 grid grid-cols-3 gap-6 md:grid-cols-6">
            <div className="flex flex-col items-center">
              <div className="h-12 w-12 rounded-full overflow-hidden">
                <Image src="/usa-flag.png" alt="USD" width={48} height={48} className="h-full w-full object-cover" />
              </div>
              <span className="mt-2 text-sm font-medium">USD</span>
            </div>
            <div className="flex flex-col items-center">
              <div className="h-12 w-12 rounded-full overflow-hidden">
                <Image src="/uk-flag.png" alt="GBP" width={48} height={48} className="h-full w-full object-cover" />
              </div>
            ...
            <div className="flex flex-col items-center">
              <div className="h-12 w-12 rounded-full overflow-hidden">
                <Image src="/ghana-flag.png" alt="GHS" width={48} height={48} className="h-full w-full object-cover" />
              </div>
