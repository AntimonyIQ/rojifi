        ...
        <section className="py-16 md:py-24 bg-gray-50">
            <div className="container">
                <div className="grid gap-12 md:grid-cols-2 items-center">
                    ...
                    >
                        <h2 className="text-3xl font-bold tracking-tight">Unbeatable Perks</h2>
                        ...
                        <div className="mt-8">
                            <Button variant="outline" className="bg-white border-amber-200 hover:bg-amber-100 hover:text-amber-900">
