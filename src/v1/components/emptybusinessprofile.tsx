...
export default class EmptyBusinessProfile extends React.Component<EmptyBPProps> {
        ...
        return (
            <div className="w-full flex flex-col items-center justify-center">
                ...
                <div className="flex flex-col items-center text-center justify-center gap-2 mt-3">
                    <h2 className="font-bold">No {statusFilter}</h2>
                    <p>
                        You currently have no {statusFilter}, Create one by clicking on the <br />
                        <span className="text-blue-500 font-medium">"Submit KYC"</span> button,
                        or check any of the other tabs to see your other business profile
                    </p>
