          ...
          <div className="flex gap-2 mb-12">
            <button
              ...
              className={`px-6 py-2 rounded-lg text-sm font-medium transition-colors ${
                activeTab === "Weekly" ? "bg-primary text-white" : "bg-gray-100 text-gray-600 hover:bg-gray-200"
              }`}
            >
              Weekly
            </button>
            <button
              ...
              className={`px-6 py-2 rounded-lg text-sm font-medium transition-colors ${
                activeTab === "Monthly" ? "bg-primary text-white" : "bg-gray-100 text-gray-600 hover:bg-gray-200"
              }`}
            >
              Monthly
            </button>
