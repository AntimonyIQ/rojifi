...
export function DirectorShareholderFormComponent({ sender }: { sender: ISender }) {
    ...
    useEffect(() => {
        const existingDirectors: Array<IDirectorAndShareholder> = (sender.directors || []) as Array<IDirectorAndShareholder>;
        ...
        const mapped = existingDirectors.map(d => ({
            ...
            shareholderPercentage: d.shareholderPercentage !== undefined && d.shareholderPercentage !== null ? String(d.shareholderPercentage) : "",
