...
const faqs = [
    {
        ...
        answer: "We are a cross-border company. We give your business a global reach with easy access to local and international transfers, coporate FX payments, currency swap and payment collections."
    },
    {
        question: "What currencies does Rojifi support?",
        answer: "Currently, Rojifi supports local collection in NGN, ZAR, KES, and international payouts across 120+ countries, including USD, EUR, GBP, CNY, and CAD"
    },
    {
        question: "How quickly can I send money internationally with Rojifi?",
        answer: "International Payments are completed on the same day, or T+1 in some jurisdiction",
    },
    {
        question: "Can I receive payments from overseas into my local business account with Rojifi?",
        answer: "With Rojifi's multi-currency accounts, you can send and receive money to and fro."
    },
    /*
    {
    ...
    */
    {
        ...
        answer: "For extra support, please reach out to us at support@rojifi.com. We are available for you around the clock."
    },
    {
                ...
                <div className="grid gap-8 md:grid-cols-[300px_1fr] lg:grid-cols-[400px_1fr] lg:gap-16">
                    ...
                    >
                        ...
                        <p className="mt-4 text-muted-foreground">
                            Find answers to common questions about our services, features, and processes. If you need further
